...
if (demoRoute?.rewrite !== '/demo.html') {
  throw new Error('The production site must expose its canonical /demo document.')
}
const trailingDemo = readFileSync(resolve('dist/site/demo/index.html'), 'utf8')
if (!trailingDemo.includes('http-equiv="refresh" content="0; url=/demo"') || !trailingDemo.includes('rel="canonical" href="https://browser-game-replay-capsule.sociobot.in/demo"')) {
  throw new Error('The static /demo/ document must immediately resolve to canonical /demo.')
}
