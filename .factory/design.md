...
The social preview (`site/public/assets/replay-capsule-social.png`, 1200×630) and apple-touch icon (`site/public/apple-touch-icon.png`, 180×180) are hand-composed derivatives of that original project illustration: the existing image is centered on the documented cream enamel field with no added text or external artwork. They were made locally on 2026-08-30 and use the same project-only provenance and license.
